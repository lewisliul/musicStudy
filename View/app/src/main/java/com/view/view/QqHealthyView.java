...
import com.view.R;
import com.view.util.ViewUtils;
...
public class QqHealthyView extends View {
    private static final String TAG = "QqHealthyView";
    ...
    private int mWidth;
    private int mHeight;
    private int mArcCenterX;   //最上面圆弧中心
    private int mArcCenterY;
    private RectF mArcRect;     //圆弧的外接矩形
    ...
    private void init() {
        ...
        mDefaultThemeColor = mContext.getResources().getColor(R.color.qqview_default_color);
        ...
        mDashLinePaint.setColor(mContext.getResources().getColor(R.color.qqview_xuxian_color));
        ...
        stepAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                step = (int) valueAnimator.getAnimatedValue();
                invalidate();
            }
        });
